...
public class King implements PieceObj {
	 ...
	 * @param s where it is.
	 * @param friends It's underlings.
	 * @param enemy offensive piece group.
	 * @return is it in check or is it not.
	 */
	...
	/**
	 * Generate new castling booleans when doing a chess move.
	 * @param a starting square of a move.
	 * @param my my pieces.
	 * @return new bools that tell us if castling is ok or not.
	 */
	...
	/**
	 * Do the castling if needed.
	 * @param my my pieces.
	 * @param nSqPtMap map of my pieces. where they are on the board and what they are.
	 * @param a starting point of a chess move.
	 * @param b ending point of a chess move.
	 */
