 ...
 * @author pyry
 */
public class KingEatsQueenTest {
	
	public KingEatsQueenTest() {
	}
	...
	public void hello() {
		...
		sqPtMap1.put(Square.A1, PieceT.KING);
		...
		sqPtMap2.put(Square.B2, PieceT.QUEEN);
		...
		PieceGroup pg1 = new PieceGroup(sqPtMap1, pTpMap1, Square.A1, castling, epp, pc1);
